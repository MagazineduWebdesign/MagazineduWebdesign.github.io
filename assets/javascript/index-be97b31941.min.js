 ...
 * License: MIT
 */
function(e){e&&(e.fn.headroom=function(t){return this.each(function(){var n=e(this),i=n.data("headroom"),r="object"==typeof t&&t;r=e.extend(!0,{},Headroom.options,r),i||(i=new Headroom(this,r),i.init(),n.data("headroom",i)),"string"==typeof t&&i[t]()})},e("[data-headroom]").each(function(){var t=e(this);t.headroom(t.data())}))}(window.Zepto||window.jQuery),function(e,t,n,i){function r(t,n){this.elements=t,this.options=e.extend({},a,n),this._defaults=a,this._name=o,this.init()}var o="VimeoThumb",a={idSelectorName:"data-vimeo-id",vimeoPatternUrl:"http://vimeo.com/api/v2/video/%id.json?callback=?"};r.prototype={init:function(){var t=this.options;e(this.elements).each(function(n,i){var r=e(i).attr(t.idSelectorName);if(r&&!/VIMEO/i.test(e(i).attr("src"))){var o=t.vimeoPatternUrl.replace(/%id/,r);e.getJSON(o,function(t){t[0]&&(e(i).hasClass("large")?e(i).attr("src",t[0].thumbnail_large):e(i).hasClass("small")?e(i).attr("src",t[0].thumbnail_small):e(i).attr("src",t[0].thumbnail_medium))})}})}},e.fn[o]=function(t){return this.each(function(){e.data(this,"plugin_"+o)||e.data(this,"plugin_"+o,new r(this,t))})}}(jQuery,window,document),/*!
 * Modernizr v2.8.3
 * www.modernizr.com
 *
