// generated on 2017-04-17 using generator-jekyllized 1.0.0-rc.7
'use strict';
...
gulp.task('assets', gulp.series(
  ...
  gulp.series('imagesmin', 'imagesresize', 'copy:assets')
));
...
gulp.task('deploy', gulp.series('imagesupload', 'upload'));
